      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mb-4 text-gray-600 dark:text-gray-300">
            We encountered an error while loading your workouts. This might be due to a temporary connection issue or a problem with our servers.
          </p>
          ...
          <div className="mb-6 rounded-lg bg-gray-50 p-4 text-left dark:bg-gray-900/50">
            ...
            <ul className="space-y-1 text-sm text-gray-600 dark:text-gray-300">
              ...
              <li>• If the problem persists, return to your profile and try again later</li>
            </ul>
          </div>
          ...
          <div className="flex justify-center gap-4">
            <Button
              onClick={reset}
              variant="default"
              aria-label="Try loading workouts again"
            >
              Try Again
            </Button>
