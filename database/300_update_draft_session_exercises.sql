-- Migration: Update draft_session_exercises to use performed_exercise_set table
--
...
COMMENT ON FUNCTION draft_session_exercises(uuid) IS
    'Generate recommended exercise parameters for a new workout session. '
    'Returns exercises with suggested weights based on previous performance. '
    'Weights increase by step_increment if progression criteria were met. '
